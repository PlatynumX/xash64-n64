# Current Xash upstream audit for r12

r12 intentionally changes only the architecture assumptions needed to create a real
Nintendo 64 target. The package audits current upstream before applying any edit.

Verified assumptions used by r12:
...
- Xash already has a low-memory mode, which r12 enables for the 8 MiB bring-up.
...
`engine/platform/n64`, r12 stops instead of silently mutating unfamiliar source.
