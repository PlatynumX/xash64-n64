# Current Xash upstream audit for r15

r15 intentionally changes only the architecture assumptions needed to create a real
Nintendo 64 target. The package audits current upstream before applying any edit.

Verified assumptions used by r15:
...
- Xash already has a low-memory mode, which r15 enables for the 8 MiB bring-up.
...
`engine/platform/n64`, r15 stops instead of silently mutating unfamiliar source.
